...
describe('test Ellipses', () => {
    ...
    test("edge visits", () => {
        ...
        expect(e.edges.map(e => e.s())).toEqual([
            "E(0:(-0.922,-0.775),(0.922,-0.775))",
            "E(0:(0.922,-0.775),(0.922,0.775))",
            "E(0:(0.922,0.775),(-0.922,0.775))",
            "E(0:(-0.922,0.775),(-0.922,-0.775))",
            "E(1:(-1.732,0),(-0.922,-0.775))",
            "E(1:(-0.922,-0.775),(0.922,-0.775))",
            "E(1:(0.922,-0.775),(1.732,0))",
            "E(1:(1.732,0),(-1.732,0))",
            "E(2:(1.732,0),(0.922,0.775))",
            "E(2:(0.922,0.775),(-0.922,0.775))",
            "E(2:(-0.922,0.775),(-1.732,0))",
            "E(2:(-1.732,0),(1.732,0))",
            "E(3:(0.5,0),(0.5,0))",
        ])
        expect(e.regions.map(r => regionString(r))).toEqual([

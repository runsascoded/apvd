...
// 5-set FizzBuzz: first 5 primes {2, 3, 5, 7, 11} (LCM = 2310)
// φ(2310) = 480; exclusive(S) = 480 / ∏_{p∈S}(p-1)
// Note: (2-1)=1 causes 15 pairs of duplicate exclusive values.
// Inclusive:
//   2: 1155, 3: 770, 5: 462, 7: 330, 11: 210
//   2,3: 385  2,5: 231  2,7: 165  2,11: 105
//   3,5: 154  3,7: 110  3,11:  70
//   5,7:  66  5,11:  42  7,11:  30
//   2,3,5:  77  2,3,7:  55  2,3,11: 35  2,5,7: 33  2,5,11: 21  2,7,11: 15
//   3,5,7:  22  3,5,11: 14  3,7,11: 10  5,7,11: 6
//   2,3,5,7: 11  2,3,5,11: 7  2,3,7,11: 5  2,5,7,11: 3  3,5,7,11: 2
//   2,3,5,7,11: 1
export const FizzBuzzSmallPrimes: Target[] = [
    [ "0****", 1155 ],  // 1 / 2
    [ "*1***",  770 ],  // 1 / 3
    [ "**2**",  462 ],  // 1 / 5
    [ "***3*",  330 ],  // 1 / 7
...
// 5-set FizzBuzz: odd primes {3, 5, 7, 11, 23} (LCM = 26565)

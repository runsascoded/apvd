...
import { useHotkeysContext, Kbd } from 'use-kbd'
    ...
    return (
        <div className={css.fab}>
            <OverlayTrigger
                overlay={
                    <Tooltip>
                        Toggle theme <Kbd action="Global:toggle-theme" clickable={false} />
                    </Tooltip>
                }
            ...
            >
                <a
                    className={css.fabButton}
                    href="https://github.com/runsascoded/apvd"
                    target="_blank"
            ...
            <OverlayTrigger
                overlay={
                    <Tooltip>
                        Keyboard shortcuts <Kbd action="__hotkeys:modal" clickable={false} />
                    </Tooltip>
                }
                popperConfig={tooltipPopperConfig}
            >
